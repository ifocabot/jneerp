                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown {{ request()->routeIs('erp.*') ? 'active' : '' }}">
                            ...
                            <ul class="dropdown-menu">
                                <li class="{{ request()->routeIs('erp.dashboard') ? 'active' : '' }}"> <a
                                        class="nav-link" href="{{ route('erp.dashboard') }}">Fleet Dashboard</a></li>
                                <li class="{{ request()->routeIs('ticket.dashboard') ? 'active' : '' }}"><a
                                        class="nav-link" href="{{ route('ticket.dashboard') }}">Ticket Dashboard</a>
                                </li>
                        ...
                        <li class="nav-item dropdown {{ request()->routeIs('oddo.*') ? 'active' : '' }}">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{ request()->routeIs('datebensin2') ? 'active' : '' }}"><a class="nav-link"
                                        href="{{ route('datebensin2') }}">Monitoring BBM</a></li>
                        ...
                        <li class="nav-item dropdown {{ request()->routeIs('ticket.*') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                                    class="fas fa-columns"></i> <span>Ticketing</span></a>
                            <ul class="dropdown-menu">
                                <li class="{{ request()->routeIs('ticket.create') ? 'active' : '' }}"><a
                                        class="nav-link" href="{{ route('ticket.create') }}">Ticket</a></li>
                                <li class="{{ request()->routeIs('ticket.inbox') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('ticket.inbox') }}">
                                        Inbox
                                        <span class="badge badge-primary" style="width:40px; margin-left: 10px;">
