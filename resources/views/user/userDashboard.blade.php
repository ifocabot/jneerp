...
<div class="flex p-4 pt-8 pb-8 pl-6 text-2xl">
    ...
    <div class="pt-3 pl-4 ml-4">
        <h3 class="font-semibold"><a href="{{ route('oddoOption') }}">Input Oddo</a></h3>
    </div>
</div>
...
<div class="flex p-4 pt-8 pb-8 pl-6 text-2xl">
    ...
    <div class="pt-3 pl-4 ml-4">
        <h3 class="font-semibold"><a href="{{ route('inputbensin') }}">Input Transaksi Bensin</h3></a>
    </div>
</div>
