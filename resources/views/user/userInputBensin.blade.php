...
<h1 class="pt-4 pl-4 text-2xl font-bold">FORM INPUT BENSIN</h1>
...
<form action="{{ route('prosesinputbensin') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex p-4 pt-8 pb-8 pl-6 ">
        ...
        <div class="w-full pl-2 ml-4">
            ...
            <input type="date" class="w-full rounded-lg" name="tanggal"
    ...
    <div class="flex p-4 pt-8 pb-8 pl-6 ">
        ...
        <div class="w-full pl-2 ml-4">
            ...
            <input type="number" class="w-full rounded-lg" name="oddo_terakhir">
        </div>
    </div>
    ...
    <div class="flex p-4 pt-8 pb-8 pl-6 ">
        ...
        <div class="w-full pl-2 ml-4">
            <span class="font-bold">Total Pembelian </span>
            <input type="number" class="w-full rounded-lg" name="total_pembelian">
        </div>
    </div>
    ...
    <div class="flex p-4 pt-8 pb-8 pl-6">
        ...
        <div class="w-full pl-2 ml-4">
            ...
            <select class="w-full " name="lokasi_pengisian" id="lokasi_pengisian">
                <option value="SPBU Puri">SPBU Puri</option>
                <option value="SPBU Koja">SPBU Koja</option>
            </select>
        </div>
    </div>
    ...
    <div class="flex p-4 pt-8 pb-8 pl-6">
        ...
        <div class="w-full pl-2 ml-4">
            ...
            <select class="w-full js-example-basic-single" name="users_id" id="users_id">
                @foreach ($users as $k)
    ...
    <div class="flex p-4 pt-8 pb-8 pl-6">
        ...
        <div class="w-full pl-2 ml-4">
            <span class="font-bold">Tipe Bensin</span>
            <select class="w-full js-example-basic-single" name="gasoline_id">
                @foreach ( $tipebensin as $bensin)
                <option value="{{ $bensin->id }}">{{ $bensin->nama_bensin }}</option>
                @endforeach
            </select>
        </div>
    </div>
